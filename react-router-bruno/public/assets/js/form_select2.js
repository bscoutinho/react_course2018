...
$(function() {
    ...
    $('.select-radar-azul').select2({
        minimumResultsForSearch: Infinity,
        containerCssClass: 'bg-primary-400'

    });

    $('.select-radar-azul-search').select2({
        containerCssClass: 'bg-primary-400'
    });

    $('.select-radar-laranja').select2({
        minimumResultsForSearch: Infinity,
        containerCssClass: 'bg-orange-400'
    });

    $('.select-radar-laranja-search').select2({
        containerCssClass: 'bg-orange-400'
    });
